...
version: alpha
name: Platform-Light
description: AI SaaS workflow builder, light-first. Off-white page, white panels, sunken canvas, hairline borders, layered soft shadows, single violet accent. Builder-heavy, config-mode surfaces.
colors:
  primary: "#101014"
  secondary: "#4b5058"
  tertiary: "#62676f"
